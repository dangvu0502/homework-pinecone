      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Drag and drop files or click to browse. Supports PDF, PNG, JPG,
              JPEG, SVG, CSV, and TXT files up to 10MB each.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            >
              <CardContent className="py-12 px-8 text-center">
                ...
                <div className="space-y-6">
                  <div
                    className={`w-20 h-20 mx-auto rounded-full p-5 transition-all duration-300 ${
